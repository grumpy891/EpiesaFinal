...
public class Footer1 extends BasePage {
    private static final Logger LOG = LoggerFactory.getLogger(Footer1.class);
    private static Footer1 instance;
    ...
    private By magazinCJ = By.xpath("//a[@title='magazin piese auto CLUJ-NAPOCA']");
    ...
    public static Footer1 getInstance() {
        if (instance == null) {
            instance = new Footer1();
        }
        return instance;
